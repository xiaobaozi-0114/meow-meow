...
export const emergencyTips: EmergencyTip[] = [
  {
    id: 'flutd-urinary-blockage',
    disease: '下泌尿道疾病 / 尿闭',
    aliases: ['尿频', '尿血', '尿不出', '膀胱炎', '结石', 'FLUTD'],
    category: '泌尿',
    risk: '急诊',
    symptoms: ['频繁进猫砂盆、每次尿很少或没有尿', '排尿时叫、蹲很久、舔生殖区域', '尿中带血、乱尿、精神差或呕吐'],
    vetAdvice: ['公猫尿不出按急诊处理，不要预约到第二天', '带上排尿记录、近期饮食、用药和猫砂盆照片', '需要兽医判断是否阻塞、结石、感染或应激性膀胱炎'],
    homeCare: ['先把猫放进安静房间观察是否真的有尿', '准备运输笼，减少追逐和惊吓', '少量提供清水，尽快出发就医'],
    doNot: ['不要按压膀胱', '不要自行喂止痛药、消炎药或利尿药', '不要因为还能滴几滴尿就继续观察'],
    emergencySigns: '完全尿不出、反复蹲砂盆、腹部疼痛、呕吐、虚弱或公猫疑似尿闭，应立即急诊。',
    sources: [
      { label: 'Cornell FLUTD', url: 'https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center/health-information/feline-health-topics/feline-lower-urinary-tract-disease' },
      { label: 'Cornell bladder and kidney stones', url: 'https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center/health-information/feline-health-topics/bladder-and-kidney-stones' },
    ],
  },
  {
    id: 'respiratory-distress',
    disease: '呼吸困难 / 急性呼吸异常',
    aliases: ['张口呼吸', '喘', '呼吸急促', '牙龈发紫', '肺炎', '哮喘'],
    category: '呼吸',
    risk: '急诊',
    symptoms: ['张口呼吸、腹部用力呼吸、呼吸很快', '舌头或牙龈发紫、发白', '趴着不愿动、无法平躺、突然虚弱'],
    vetAdvice: ['呼吸异常优先级极高，应直接急诊', '途中保持安静通风，提前电话告知医院', '需要医院评估缺氧、肺部、心脏、哮喘或胸腔问题'],
    homeCare: ['不要反复抱起检查，减少刺激', '保持环境凉爽通风', '把猫放入运输笼后尽快出发'],
    doNot: ['不要强行喂水喂食', '不要自行使用吸氧设备或人用药', '不要拍视频很久再决定是否就医'],
    emergencySigns: '任何张口呼吸、牙龈发紫、明显喘不过气，都按急诊处理。',
    sources: [
  ...
  },
  {
    ...
    disease: '上呼吸道感染 / 猫鼻支',
    aliases: ['猫感冒', '打喷嚏', '流鼻涕', '流眼泪', '疱疹病毒', '杯状病毒'],
    category: '呼吸',
    risk: '尽快就医',
    symptoms: ['打喷嚏、流鼻涕、鼻塞、眼分泌物', '发热、食欲下降、精神变差', '口腔溃疡、流口水、咳嗽或呼吸声重'],
    vetAdvice: ['幼猫、老年猫、多猫家庭或不吃东西时应尽快看兽医', '需要判断病毒、细菌继发感染、眼部问题或脱水', '多猫家庭建议隔离并清洁食盆水碗'],
    homeCare: ['保持房间温暖、通风但不直吹', '用温湿棉片轻轻擦眼鼻分泌物', '提供气味强、适口性好的主食湿粮，观察饮水和尿量'],
    doNot: ['不要喂人用感冒药', '不要自行滴抗生素眼药或鼻药', '不要让病猫和其他猫共用餐具'],
    emergencySigns: '张口呼吸、完全不吃、幼猫明显虚弱、眼睛睁不开或黄绿色分泌物明显时应尽快就医。',
    sources: [
      { label: 'International Cat Care cat flu', url: 'https://icatcare.org/articles/cat-flu-upper-respiratory-infection' },
      { label: 'International Cat Care FHV', url: 'https://icatcare.org/articles/feline-herpesvirus-fhv' },
    ],
  },
  {
    id: 'vomiting-diarrhea',
    disease: '呕吐腹泻 / 急性胃肠道问题',
    aliases: ['软便', '拉稀', '便血', '吐黄水', '胃肠炎', '肠胃炎'],
    category: '消化',
    risk: '尽快就医',
    symptoms: ['一天内多次呕吐或腹泻', '便血、黑便、无法留住水', '精神差、腹痛、脱水、食欲明显下降'],
    vetAdvice: ['幼猫、老年猫、连续呕吐、血便或疑似异物要尽快就医', '带上粪便照片、呕吐物照片、近期换粮和零食记录', '需要排查寄生虫、异物、中毒、胰腺或炎症性肠病等原因'],
    homeCare: ['暂停新食物、新零食和可疑食材', '少量多次提供清水，记录呕吐和排便频次', '保持猫砂盆清洁，便样可留少量给医院检查'],
    doNot: ['不要自行喂止泻药、抗生素或人用胃药', '不要强行禁水', '不要继续喂引发问题的食物'],
    emergencySigns: '连续呕吐、血便、精神沉郁、腹部明显疼痛、幼猫腹泻或无法喝水，应尽快就医。',
    sources: [
      { label: 'VCA cat emergencies', url: 'https://vcahospitals.com/know-your-pet/emergencies-in-cats' },
      { label: 'Cornell internal medicine conditions', url: 'https://www.vet.cornell.edu/hospitals/services/imaging-service/internal-medicine-medical-conditions' },
    ],
  },
  {
    id: 'dehydration',
    disease: '脱水',
    aliases: ['不喝水', '皮肤弹性差', '眼窝凹陷', '虚弱', '口腔干'],
    category: '全身状态',
    risk: '尽快就医',
    symptoms: ['精神差、虚弱、食欲差', '牙龈或口腔黏膜偏干', '严重时眼窝凹陷、站不稳'],
    vetAdvice: ['持续呕吐腹泻、不吃不喝或慢病猫疑似脱水要尽快就医', '医院可能需要判断脱水程度和基础病原因', '幼猫和老年猫不要长时间在家观察'],
    homeCare: ['提供新鲜水和湿粮，少量多次尝试', '记录饮水、尿量、体重和精神变化', '保持环境凉爽，避免高温和应激'],
    doNot: ['不要强灌大量水', '不要自行皮下补液', '不要只用猫条代替补水和就医'],
    emergencySigns: '无法站稳、持续呕吐、眼窝凹陷、完全不吃不喝或伴随尿闭，应立即就医。',
    sources: [
      { label: 'Cornell hydration', url: 'https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center/health-information/feline-health-topics/hydration' },
    ],
  },
  {
    id: 'chronic-kidney-disease',
    disease: '慢性肾病',
    aliases: ['CKD', '肾衰', '多饮多尿', '老年猫肾病', '肌酐高'],
    category: '泌尿 / 老年病',
    risk: '尽快就医',
    symptoms: ['喝水变多、尿量变多', '体重下降、食欲变差、呕吐或恶心', '毛发变差、精神下降、口气变重'],
    vetAdvice: ['老年猫出现多饮多尿或体重下降应做体检和血尿检查', '确诊后需要兽医制定饮食、补水、血压和复查计划', '不要只靠保健品延误检查'],
    homeCare: ['记录每日饮水、尿团大小、体重和食量', '增加湿粮和饮水点，减少应激', '带上既往体检报告和近期饮食信息'],
    doNot: ['不要自行换处方粮替代诊断', '不要随意补钙、补磷或喂人用肾药', '不要忽视突然不吃、呕吐和脱水'],
    emergencySigns: '肾病猫突然不吃、连续呕吐、明显脱水、虚弱或尿量异常变化，应尽快就医。',
    sources: [
      { label: 'Cornell chronic kidney disease', url: 'https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center/health-information/feline-health-topics/chronic-kidney-disease' },
      { label: 'Cornell hypertension', url: 'https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center/health-information/feline-health-topics/hypertension' },
    ],
  },
  {
    id: 'diabetes',
    disease: '糖尿病',
    aliases: ['多饮多尿', '血糖高', '尿糖', '糖猫', '体重下降'],
    category: '内分泌',
    risk: '尽快就医',
    symptoms: ['喝水和尿量明显增加', '食欲增加但体重下降', '后肢无力、毛发差、精神变化'],
    vetAdvice: ['疑似糖尿病需要血糖、尿检和并发症评估', '已用药猫出现低血糖迹象要及时联系兽医', '饮食和用药必须按兽医计划调整'],
    homeCare: ['记录饮水、尿量、食欲和体重趋势', '保持规律喂食，不要突然断食', '已确诊猫按医嘱监测，不随意改剂量'],
    doNot: ['不要自行使用胰岛素或降糖药', '不要因多吃就无限加餐', '不要忽略虚弱、站不稳、抽搐等低血糖风险'],
    emergencySigns: '已确诊糖尿病猫出现虚弱、呕吐、站不稳、抽搐或昏迷，应立即联系兽医或急诊。',
    sources: [
      { label: 'Cornell feline diabetes', url: 'https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center/health-information/feline-health-topics/feline-diabetes' },
    ],
  },
  {
    id: 'hyperthyroidism',
    disease: '甲状腺功能亢进',
    aliases: ['甲亢', '吃很多还瘦', '老年猫消瘦', '多饮多尿', '亢奋'],
    category: '内分泌 / 老年病',
    risk: '尽快就医',
    symptoms: ['吃得多但体重下降', '喝水和尿量变多', '呕吐、腹泻、过度活跃、毛发油乱'],
    vetAdvice: ['中老年猫出现吃多变瘦应做甲状腺和全身检查', '需要兽医评估心脏、血压、肾脏和治疗方案', '治疗后也需要定期复查'],
    homeCare: ['记录体重、食量、饮水和排便变化', '保持稳定饮食，不要频繁换粮掩盖症状', '预约体检并带上近期体重曲线'],
    doNot: ['不要自行购买甲状腺药', '不要把消瘦简单归因于挑食或年纪大', '不要忽视心跳快、喘、虚弱等情况'],
    emergencySigns: '消瘦明显、持续呕吐腹泻、呼吸异常、虚弱或疑似心脏问题时应尽快就医。',
    sources: [
      { label: 'Cornell hyperthyroidism', url: 'https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center/health-information/feline-health-topics/hyperthyroidism-cats' },
    ],
  },
  {
    id: 'dental-disease',
    disease: '牙周病 / 口炎',
    aliases: ['口臭', '牙龈红肿', '流口水', '不敢咬', '牙结石', '口炎'],
    category: '口腔',
    risk: '尽快就医',
    symptoms: ['口臭、牙结石、牙龈红肿或出血', '流口水、偏侧咀嚼、吃饭掉粮', '不愿被碰嘴、体重下降或食欲变差'],
    vetAdvice: ['明显疼痛、出血、拒食或牙龈红肿应看兽医', '口腔问题常需专业检查，必要时拍片和洁牙处理', '长期口臭不是正常现象'],
    homeCare: ['能配合的猫可逐步训练刷牙', '提供适合的主食和清水，观察进食疼痛', '拍照记录牙龈和口腔变化给医生看'],
    doNot: ['不要硬掰嘴反复检查造成应激', '不要自行刮牙结石', '不要给人用止痛药或口腔喷剂'],
    emergencySigns: '完全不吃、口腔出血、面部肿胀、流口水严重或疑似牙根脓肿，应尽快就医。',
    sources: [
      { label: 'VCA dental care', url: 'https://vcahospitals.com/parkwood/services/primary-care/dental-care' },
      { label: 'VCA dentistry overview', url: 'https://vcahospitals.com/stoney-creek/services/primary-care/dentistry' },
    ],
  },
  {
    id: 'skin-ringworm-allergy',
    disease: '皮肤病 / 猫癣 / 过敏',
    aliases: ['掉毛', '皮屑', '结痂', '瘙痒', '真菌', '猫癣', '过敏'],
    category: '皮肤',
    risk: '观察',
    symptoms: ['局部掉毛、皮屑、红斑、结痂', '频繁抓挠、舔咬、耳后或脸部脱毛', '多猫家庭或人也出现皮肤问题'],
    vetAdvice: ['扩散快、幼猫、多猫家庭或人被传染时应就医检查', '需要区分真菌、寄生虫、过敏、细菌感染等原因', '确诊前不要随意混用外用药'],
    homeCare: ['先减少与其他猫密切接触，清洗猫窝和织物', '拍照记录皮损位置和变化', '保持环境干燥清洁，避免频繁洗澡刺激皮肤'],
    doNot: ['不要使用人用皮炎药膏', '不要给猫舔到外用药', '不要剃光或过度洗澡'],
    emergencySigns: '大面积溃烂、化脓、精神差、幼猫迅速扩散或人也出现皮损，应尽快就医。',
    sources: [
      { label: 'Cornell Feline Health Topics', url: 'https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center/health-information/feline-health-topics' },
    ],
  },
  {
    id: 'ear-mites-otitis',
    disease: '耳螨 / 外耳炎',
    aliases: ['甩头', '抓耳朵', '耳朵臭', '黑褐色耳垢', '耳炎'],
    category: '耳部',
    risk: '观察',
    symptoms: ['频繁甩头、抓耳朵', '耳道黑褐色分泌物、异味', '耳朵红肿、疼痛、不愿被碰'],
    vetAdvice: ['分泌物多、疼痛、异味或反复发作应做耳道检查', '需要区分耳螨、细菌、真菌、异物或过敏', '多猫家庭可能需要一起评估'],
    homeCare: ['拍照记录耳垢状态，不要深掏', '保持耳部干燥，避免洗澡进水', '就医前不要混用多种滴耳液'],
    doNot: ['不要用棉签深入耳道', '不要用酒精、双氧水清耳', '不要自行长期滴药'],
    emergencySigns: '头歪、走路不稳、耳朵剧痛、出血或面部神经异常，应尽快就医。',
    sources: [
      { label: 'Cornell Feline Health Topics', url: 'https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center/health-information/feline-health-topics' },
    ],
  },
  {
    id: 'eye-problems',
    disease: '眼部感染 / 结膜炎',
    aliases: ['流眼泪', '眼屎多', '眯眼', '眼睛红', '角膜', '结膜炎'],
    category: '眼部',
    risk: '尽快就医',
    symptoms: ['流泪、眼屎增多、结膜发红', '眯眼、怕光、频繁揉眼', '角膜发白、眼睛睁不开或眼球外观异常'],
    vetAdvice: ['眯眼疼痛、角膜异常、分泌物明显或幼猫眼病应尽快就医', '眼病可能和上呼吸道感染、外伤或角膜溃疡有关', '需要兽医检查后决定是否用眼药'],
    homeCare: ['用干净温湿棉片轻轻擦外部分泌物', '戴伊丽莎白圈防止抓挠', '记录是否伴随喷嚏、鼻涕和食欲下降'],
    doNot: ['不要使用人用眼药水', '不要自行滴抗生素或激素眼药', '不要揉眼或强行扒开眼睛'],
    emergencySigns: '眼睛睁不开、明显疼痛、角膜变白或变蓝、外伤、突然视力异常，应尽快就医。',
    sources: [
      { label: 'International Cat Care runny eyes', url: 'https://icatcare.org/articles/runny-eyes' },
      { label: 'International Cat Care cat flu', url: 'https://icatcare.org/articles/cat-flu-upper-respiratory-infection' },
    ],
  },
  {
    id: 'parasites',
    disease: '体内外寄生虫',
    aliases: ['跳蚤', '绦虫', '蛔虫', '拉虫', '黑色颗粒', '驱虫'],
    category: '寄生虫',
    risk: '观察',
    symptoms: ['频繁抓挠、皮肤黑色小颗粒、掉毛', '粪便或肛门周围可见虫体或米粒样节片', '软便、消瘦、幼猫肚子大'],
    vetAdvice: ['幼猫、消瘦、贫血、持续腹泻或看到虫体应咨询兽医', '驱虫选择要按年龄、体重、生活环境和寄生虫类型判断', '多宠家庭通常需要同步管理环境和宠物'],
    homeCare: ['记录体重和粪便情况，拍照留证', '清洗猫窝、地毯和常待区域', '购买驱虫产品前确认适用年龄和体重范围'],
    doNot: ['不要把狗用驱虫药给猫用', '不要超剂量或叠加多种驱虫药', '不要忽视环境清洁'],
    emergencySigns: '幼猫虚弱、牙龈苍白、持续腹泻、呕吐虫体或疑似用错驱虫药，应尽快就医。',
    sources: [
      { label: 'Cornell Feline Health Topics', url: 'https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center/health-information/feline-health-topics' },
    ],
  },
  {
    id: 'poison-foreign-body',
    disease: '中毒 / 误食异物',
    aliases: ['误食', '百合', '清洁剂', '药物', '线绳', '异物', '中毒'],
    category: '中毒 / 异物',
    risk: '急诊',
    symptoms: ['确认或怀疑吃了药物、百合、清洁剂、线绳或异物', '呕吐、流口水、抽搐、虚弱、呼吸异常', '腹痛、持续干呕、排便异常'],
    vetAdvice: ['先联系急诊医院或宠物中毒热线，按对方要求带包装和照片', '线绳异物、百合和人药误食不应等症状出现', '需要医院判断是否催吐、解毒、影像检查或住院'],
    homeCare: ['保留包装、植物、异物残留和呕吐物照片', '记录误食时间、可能剂量和猫体重', '把猫限制在安全空间，尽快出发'],
    doNot: ['不要自行催吐', '不要喂牛奶、油、盐水或偏方', '不要拉扯露在口腔或肛门外的线'],
    emergencySigns: '误食百合、人药、清洁剂、线绳、电池、尖锐物或出现抽搐、呼吸异常，应立即急诊。',
    sources: [
  ...
  {
    id: 'trauma-bite-wound',
    disease: '外伤 / 咬伤 / 坠落',
    aliases: ['坠楼', '车祸', '打架', '咬伤', '跛行', '出血'],
    category: '外伤',
    risk: '急诊',
    symptoms: ['明显出血、跛行、疼痛、躲藏', '坠楼、车祸、被咬后外表看似正常', '呼吸异常、牙龈苍白、腹部疼痛或精神差'],
    vetAdvice: ['高处坠落、车祸、咬伤和明显跛行都建议尽快检查', '猫会隐藏疼痛，外表正常也可能有内伤', '咬伤容易形成脓肿，需要兽医评估'],
    homeCare: ['用毛巾轻柔包裹，减少挣扎', '出血处用干净纱布轻压', '尽快送医，途中保持安静和保暖'],
    doNot: ['不要强行复位骨折', '不要给人用止痛药', '不要因能走路就取消检查'],
    emergencySigns: '持续出血、呼吸异常、牙龈苍白、无法站立、坠楼车祸或疑似骨折，应立即急诊。',
    sources: [
      { label: 'VCA emergency care overview', url: 'https://vcahospitals.com/know-your-pet/emergencies-in-cats' },
    ],
  },
  {
    id: 'not-eating-lethargy',
    disease: '食欲废绝 / 精神沉郁',
    aliases: ['不吃饭', '没精神', '嗜睡', '躲起来', '厌食'],
    category: '全身状态',
    risk: '尽快就医',
    symptoms: ['超过 24 小时几乎不吃', '明显躲藏、反应慢、活动减少', '伴随呕吐、腹泻、发热、疼痛或体重下降'],
    vetAdvice: ['幼猫、肥胖猫、糖尿病猫或伴随其他症状应更早就医', '不吃只是信号，背后可能是疼痛、感染、肠胃、泌尿或内分泌问题', '需要兽医体检和必要化验找原因'],
    homeCare: ['记录最后进食时间、饮水、排尿排便和体重', '提供平时爱吃的主食湿粮，不要频繁换大量新食物', '保持安静温暖，减少打扰'],
    doNot: ['不要强灌大量食物', '不要用猫条长期拖延', '不要自行喂人用胃药或止痛药'],
    emergencySigns: '幼猫不吃、超过 24 小时不吃、精神明显沉郁、伴随尿闭或呼吸异常，应尽快就医。',
    sources: [
      { label: 'Cornell Choosing and Caring for Your New Cat', url: 'https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center/health-information/feline-health-topics/choosing-and-caring-your-new-cat' },
      { label: 'VCA emergency care overview', url: 'https://vcahospitals.com/know-your-pet/emergencies-in-cats' },
    ],
